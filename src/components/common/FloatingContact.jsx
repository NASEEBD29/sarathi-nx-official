  ...
  return (
    <div className="fixed bottom-6 right-5 z-[100] flex flex-col gap-3">
      ...
      <a
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center text-2xl shadow-xl hover:bg-[#002B75] hover:scale-110 transition-all duration-300"
      >
        <FaWhatsapp />
      </a>
